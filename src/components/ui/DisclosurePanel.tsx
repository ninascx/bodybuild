...
export function DisclosurePanel({
  ...
  return (
    ...
    >
      <summary
        className={cn(
          'flex min-h-11 cursor-pointer list-none items-center justify-between gap-3 rounded-md px-3 py-2 text-sm font-semibold text-slate-800 transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300 dark:text-slate-200 dark:hover:bg-slate-900 dark:focus-visible:ring-emerald-600',
          summaryClassName,
        )}
      >
