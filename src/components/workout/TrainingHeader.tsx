      ...
      {restActive ? (
        ...
        <div className="mt-3 grid gap-2">
          <Button
            variant="secondary"
            onClick={onStartRest}
            className="border-orange-300 text-orange-700 shadow-none hover:bg-orange-50 dark:border-orange-600/40 dark:text-orange-300 dark:hover:bg-orange-900/30"
          >
