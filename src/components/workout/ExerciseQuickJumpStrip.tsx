...
export function ExerciseQuickJumpStrip({
  ...
  return (
    <div
      ...
      className="sticky top-14 z-10 -mx-3 overflow-x-auto rounded-md border border-slate-200 bg-white/75 px-3 py-2 shadow-md backdrop-blur-lg dark:border-slate-700/50 dark:bg-slate-900/75"
    >
