...
export function ExerciseRecordHeader({
  ...
  return (
    <button
      type="button"
      onClick={onToggle}
      className="flex min-h-11 w-full flex-col gap-2 rounded-md text-left transition hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-300 dark:hover:bg-slate-800/70 dark:focus-visible:ring-orange-600 sm:flex-row sm:items-start sm:justify-between"
