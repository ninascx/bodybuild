  ...
  return (
    ...
    >
      <button
        ...
        className="w-full px-3 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300 dark:focus-visible:ring-emerald-600"
      >
