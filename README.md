...
- **记录页收敛**：首屏保留日期、复制此日、常用录入和备注；日历、围度等低频内容收进补充详情。
- **导出入口降级**：记录页的“导出此日”移到右上角“更多”菜单，避免与录入主流程抢位置。
...
- 记录页提供一屏快速记录：日期、复制此日、体重、热量、蛋白、步数、睡眠、疲劳和备注；目标提示显示在字段旁，日历和围度收在补充详情里。
...
- 记录页右上角“更多”菜单提供“导出此日”，打开后默认锚定当前记录日期。
